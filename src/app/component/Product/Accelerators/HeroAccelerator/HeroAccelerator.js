...
export default function HeroAccelertor() {
  return (
    <section className="relative bg-black text-white overflow-hidden min-h-80 mt-3 flex items-center justify-center">
      <div className="max-w-7xl px-4 sm:px-8 lg:px-12 py-16 sm:py-20 text-center">
        ...
        >
          Enable every member of the team with efficiency-boosting AI skills.
          Accelerate every step of the content lifecycle: brainstorm, develop,
          edit, organize, translate and publish content, all in Kontent.ai.
        </p>
