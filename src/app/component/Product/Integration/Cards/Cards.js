...
export default function Cards() {
  return (
    <section className="bg-black text-white px-6 sm:px-12 md:px-20 lg:px-32 py-20">
      ...
      <div className="flex justify-end mb-10">
        <select className="bg-black text-white border border-gray-600 rounded-full px-5 py-2 text-xl">
          <option>All</option>
  ...
  className="bg-[#1a1a1a] rounded-xl overflow-hidden shadow-lg flex flex-col justify-between h-[520px] transition-transform hover:-translate-y-2 duration-300"
          >
            ...
            {/* Content */}
            <div className="px-10 pb-12 flex flex-col flex-g   -black bg-opacity-40">
              <h3 className={`text-3xl font-extrabold mb-5 hover:text=${item.highlight}`}>
                {item.name}
              </h3>
