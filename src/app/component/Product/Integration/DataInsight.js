...
export default function DataInsightsIntegration() {
  const items = [
    {
      icon: "/Product/integration/Lock.svg",
    ...
    {
       icon: "/Product/integration/Diamond.svg",
    ...
    {
      icon: "/Product/integration/Fast.svg",
    ...
    <section className="bg-black text-white py-20 px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {items.map((item, idx) => (
          ...
          >
            <div className="mb-6"><Image src={item.icon} alt={item.title} height={25} width={25} /></div>
