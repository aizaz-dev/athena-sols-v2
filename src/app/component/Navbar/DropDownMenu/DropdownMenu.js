    ...
    <>
      ...
      {!isMobile && (
        <>
          {" "}
          {type === "resources" ? (
            /* ===================== RESOURCES MENU ===================== */ <div className=" fixed top-[72px] left-1/2 -translate-x-1/2 w-[960px] min-h-[480px] rounded-2xl shadow-2xl bg-[#111] text-white p-10 flex gap-10 z-50 ">
              {" "}
              {/* Sidebar links */}{" "}
            ...
            /* ===================== DEFAULT MENUS ===================== */ <div className=" fixed top-[72px] left-1/2 -translate-x-1/2 w-[1280px] min-h-[480px] rounded-2xl shadow-2xl bg-[#111] text-white p-10 flex gap-10 z-50 ">
              {" "}
              {/* 3-column section */}{" "}
